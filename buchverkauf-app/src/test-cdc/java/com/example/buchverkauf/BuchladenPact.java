package com.example.buchverkauf;
...
import com.example.buchverkauf.adapter.web.out.BuchladenClient;
...
public class BuchladenPact {
    ...
    void ladeBuecher(final MockServer mockServer) {
        ...
        // when
        final List<Buch> buecher = client.alleBuecher();
        // then
